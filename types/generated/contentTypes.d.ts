...
export interface ApiGlobalSettingsPageGlobalSettingsPage
    ...
    info: {
        singularName: "global-settings-page";
        pluralName: "global-settings-pages";
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
    ...
    attributes: {
        ...
        >;
        products: Schema.Attribute.Component<"components.product-list", true>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
    ...
    attributes: {
        ...
        brand: Schema.Attribute.Relation<"manyToOne", "api::brand.brand">;
        seo: Schema.Attribute.Component<"components.seo", false>;
        fullDesc: Schema.Attribute.RichText;
        priceRUB: Schema.Attribute.Integer;
        priceEUR: Schema.Attribute.Integer;
        line: Schema.Attribute.Relation<"manyToOne", "api::line.line">;
        crosssales: Schema.Attribute.Relation<
            "oneToMany",
            "api::product.product"
        >;
